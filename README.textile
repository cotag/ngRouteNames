h1. ngRouteNames - AngularJS Named Routes

A route provider and ng-href replacement for advanced routing and mobile device support
The @goto@ directive depends on "Angular Gesture":https://github.com/cotag/bower-angular-gesture so the links are response on mobile devices
